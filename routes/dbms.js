 ...
 */
 ...
 var host = "35.193.196.174";    //from GCloud instance (change to match your db)
 var database = "CHEESECAKE";  //database name
 var user = "root";         //username (change to match your db)
 var password = "login200";  //password (change to match your db, yes this is very poor practice)
